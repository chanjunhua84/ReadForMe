...
# Custom CSS for styling (updated to align the title to the left)
st.markdown(
    """
    <style>
    .title {
...
st.sidebar.title("🗣️ Language Selection")
...
if target_language != "Blank":
    ...
    # Check if language, QR code, or image has changed
    if target_language != st.session_state.prev_language or uploaded_file != st.session_state.prev_uploaded_file:
